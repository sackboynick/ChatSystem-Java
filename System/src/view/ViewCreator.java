...
public abstract class ViewCreator {
    ...
    protected ViewController loadFromFXML(String id) throws IOException {
        String fxmlFile = switch (id) {
            case "addFriend" -> "addFriendView.fxml";
            case "chats" -> "chatsView.fxml";
            case "createGroup" -> "createGroupView.fxml";
            case "friendsList" -> "friendsListView.fxml";
            case "groupChat" -> "groupChatView.fxml";
            case "logIn" -> "logInView.fxml";
            case "privateChat" -> "privateChatView.fxml";
            case "register" -> "registerView.fxml";
            case "forwardMessage" -> "forwardMessageView.fxml";
            case "participantList" -> "participantListView.fxml";
